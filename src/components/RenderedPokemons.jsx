...
function RenderedPokemons({ pokemon }) {
  return (
    <div
      key={pokemon.id}
      className="col-span-3  md:col-span-2 lg:col-span-1 w-72 h-[340px] border-zinc-200 rounded-2xl dark:border-zinc-700 bg-white dark:bg-zinc-900 "
    >
